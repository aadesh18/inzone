...
List<ContentModel> focusContentList = [
  ...
  ContentModel(tittle: 'mental_health', iconPath: 'icons/content_icons'),
...
List<ContentModel> fallbackContentList = [
  ...
  ContentModel(tittle: 'video_game_reviews', iconPath: 'icons/content_icons'),
...
List<ContentModel> customContentList = [
  ...
  ContentModel(tittle: 'music', iconPath: 'icons/content_icons'),

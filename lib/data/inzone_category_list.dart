...
final List<InZoneCategory> inzone_category_list = [
  InZoneCategory(
      ...
      startColor: const Color(0xff8674ED),
      endColor: const Color(0xff6048DA)),
  InZoneCategory(
      categoryName: "Humor & Memes",
      categoryIconPath: CustomIcons.humorAndMemes,
      startColor: const Color(0xff26DD90),
      endColor: const Color(0xff0EB16D)),
  InZoneCategory(
      categoryName: "Games",
      categoryIconPath: CustomIcons.games,
      startColor: const Color(0xffFFCB8D),
      endColor: const Color(0xffFFB26A)),
